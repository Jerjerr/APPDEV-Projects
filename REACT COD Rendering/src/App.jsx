...
function App() {
  ...
  //array of desserts => desserts.objects
  const desserts=[
    {id:1, name: "cake",color: "red"},
    {id:2, name: "ice cream",color: "blue"},
    {id:3, name: "pie",color: "orange"},
  ]
  return (
    <>
    <Header/>
    ...
    {fruits.length > 0 ? <ListOfFruits items={fruits} category="My Favourite Fruits" /> : <p>No Fruits</p>}
    {desserts.length > 0 ? <ListOfFruits items={desserts} category="My Favourite Desserts" /> : <p>I do not like desserts.</p>}
